...
import { Coffee, MapPin, Phone, Clock, Star, Menu, X } from 'lucide-react';
          ...
          <div className="about-content">
            ...
            <div className="about-text">
              ...
              <p className="about-paragraph">
                Born from a passion for authentic Indian flavors and warm
                hospitality, Chai & Soul brings together the best of traditional
                café culture with modern comfort.
              </p>
              <p className="about-paragraph">
                Every cup of chai is brewed with hand-picked spices, every snack
                is prepared fresh, and every guest is treated like family. We
                believe in the power of good food and great conversations.
              </p>
              <p className="about-paragraph">
      ...
      <section className="testimonials-section">
        <div className="section-container">
          <div className="section-header">
            ...
            <p className="section-subtitle">
              Real experiences from our café family
            </p>
          </div>
